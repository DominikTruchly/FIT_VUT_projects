...
/* **************** Implementation of compiler for IFJ22 ***************** */
/*  Course: Formal languages and translators (IFJ) - FIT VUT in Brno       */
...
void semanticTypeCompatibilityError(Lexeme lex) {
    printf("Precedent_analysis: Type compatibility error on line %d\n", lex.lineNumber);
    exit(7);
}
...
void push(StackItem lex){
    if(top == MAXSTACK-1) {
        printf("Precedent_analysis: Overflow State - can't add more elements PAinto the stack\n");
        internError();
    }
    else{
        top+=1;
...
void operationRule() {
    ...
    case MULTIPLICATION:
        ...
        break;
    case DIVISION:
        if (rightOP.expressionType == PINT && rightOP.lex.value == 0) semanticError(rightOP.lex);
        else if (rightOP.expressionType == PFLOAT && rightOP.lex.fvalue == 0.0) semanticError(rightOP.lex);
    ...
    case SUBSTRACTION:
        ...
        break;
    case DOT:
        if (rightOP.expressionType != PSTRING || leftOP.expressionType != PSTRING ) semanticError(rightOP.lex);
        ...
        break;
    case EQUALS:
        if (rightOP.expressionType != leftOP.expressionType) semanticError(rightOP.lex);
    ...
    case LESS:
        ...
        printf("POPS GF@var1\n");
        printf("POPS GF@var2\n");
        printf("LT GF@var1 GF@var1 GF@var2\n");
        printf("PUSHS GF@var1\n");
        break;
    case LESSEQ:
        if (rightOP.expressionType != leftOP.expressionType) semanticError(rightOP.lex);
        ...
        printf("POPS GF@var1\n");
        printf("POPS GF@var2\n");
        printf("LT GF@var3 GF@var1 GF@var2\n");
    ...
    case GREATER:
        ...
        printf("POPS GF@var1\n");
        printf("POPS GF@var2\n");
        printf("GT GF@var1 GF@var1 GF@var2\n");
        printf("PUSHS GF@var1\n");
        break;
    case GREATEREQ:
        printf("POPS GF@var1\n");
        printf("POPS GF@var2\n");
        printf("GT GF@var3 GF@var1 GF@var2\n");
        printf("EQ GF@var4 GF@var1 GF@var2\n");
        printf("OR GF@var1 GF@var3 GF@var4\n");
        printf("PUSHS GF@var1\n");
        break;
...
ItemType getItemType(Lexeme lex) {
    ...
    case KEYWORD: 
        ...
        return OPERAND;
    default:
        printf("Precedent_analysis: Invalid token for expression\n");
        syntaxError(lex);
        return ERROR;
        break;
    }
